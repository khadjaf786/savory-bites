...
export type PaymentMethod = { 'card' : null } |
  { 'cash' : null };
export type PlaceOrderError = { 'missingCardholderName' : null } |
  { 'unknownDish' : DishId } |
...
export type UpdateOrderStatusError = { 'notFound' : OrderId } |
  { 'invalidTransition' : { 'to' : OrderStatus, 'from' : OrderStatus } } |
  { 'unauthorized' : null };
...
export interface _SERVICE {
  ...
  'listDishes' : ActorMethod<[], Array<Dish>>,
